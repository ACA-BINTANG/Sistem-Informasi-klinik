...
<div class="sidebar">
  ...
  <nav class="nav flex-column">
    <a class="nav-link" href="dashboard_dokter.php?page=antrean">
      <i class="bi bi-people-fill"></i> Antrean Pasien
    </a>

    <a class="nav-link" href="dashboard_dokter.php?page=rekam_medis">
      <i class="bi bi-file-earmark-medical-fill"></i> Rekam Medis
    </a>

    <a class="nav-link" href="dashboard_dokter.php?page=rujukan">
  ...
  <nav class="nav flex-column">
    <a class="nav-link" href="dashboard_dokter.php?page=pasien">
      <i class="bi bi-person-badge-fill"></i> Data Pasien
    </a>

    <a class="nav-link" href="dashboard_dokter.php?page=diagnosa">
