...
('PG0006', 'OD0006', 'SP0006', 70, '2026-07-01', '2026-07-04', 'Pending', 'Pengadaan Vitamin C 500 mg - IPI untuk menjaga stok minimum klinik'),
...
('PG0011', 'OD0011', 'SP0011', 95, '2026-07-06', '2026-07-11', 'Pending', 'Pengadaan Amlodipine 5 mg - Norvask untuk menjaga stok minimum klinik'),
...
('PG0016', 'OD0016', 'SP0016', 120, '2026-07-11', '2026-07-15', 'Pending', 'Pengadaan Ferrous Fumarate - Sangobion untuk menjaga stok minimum klinik'),
...
-- =========================================================
-- Tambahan dari ASTARhealth(6): Stored Procedure rekam medis
-- =========================================================
DROP PROCEDURE IF EXISTS `sp_rekam_medis_pasien`;
DELIMITER $$
CREATE PROCEDURE `sp_rekam_medis_pasien` (
    IN p_id_pasien VARCHAR(20)
)
BEGIN
    SELECT
        rm.id_rekam_medis,
    ...
    ORDER BY rm.tgl_kunjungan DESC, rm.id_rekam_medis DESC;
END$$
DELIMITER ;


-- =========================================================
-- Tambahan dari ASTARhealth(6): UDF status stok
-- =========================================================
...
BEGIN
    RETURN CASE
        ...
        WHEN stok <= minimum THEN 'Minimum'
        ELSE 'Tersedia'
    END;
END$$
DELIMITER ;
