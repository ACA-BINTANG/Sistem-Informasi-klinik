...
// Laporan keuangan hanya menghitung pengadaan yang benar-benar berhasil,
// yaitu transaksi dengan status Diterima.
...
$exportUrl = "../cetak/cetak_laporan_keuangan.php";
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <small class="text-muted">Hanya menghitung pengadaan yang berhasil dan berstatus <strong>Diterima</strong>.</small>
    </div>
...
<div class="row g-3 mb-4">
    <div class="col-md-3">
        <div class="data-container text-center">
            <small class="text-muted fw-bold">TOTAL PENGADAAN BERHASIL</small>
            <h2 class="fw-bold text-primary mb-0"><?= e($totalTransaksi) ?></h2>
        </div>
    </div>
    <div class="col-md-3">
        <div class="data-container text-center">
            <small class="text-muted fw-bold">TOTAL OBAT DITERIMA</small>
...
<?php renderReportDonutChart(
    ...
    "Distribusi nilai pengadaan berhasil (status Diterima) berdasarkan nama obat.",
    $chartPerObat,
    "nama_obat",
    "total_biaya",
    true,
...
<div class="data-container">
    <div class="table-responsive">
     ...
     $r["satuan"] ?? "",
                ...
                <?php else: ?>
                    <tr><td colspan="9" class="text-center py-5 text-muted">Belum ada pengadaan berstatus Diterima pada periode ini.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>
