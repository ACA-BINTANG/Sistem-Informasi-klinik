...
if (isset($_POST["add_user"])) {
    ...
    header("Location: index.php?page=user&msg=User Berhasil Ditambah");
    exit();
}
...
if (isset($_POST["add_staff"])) {
    ...
    header(
        "Location: index.php?page=staff&msg=Staff Berhasil Didaftarkan",
    );
    exit();
}
...
if (isset($_POST["add_pasien"])) {
    ...
    if ($ok1 && $ok2) {
        header(
            "Location: index.php?page=pasien&msg=Pasien & Akun SSO Berhasil Dibuat!",
        );
        exit();
    }
}
...
if (isset($_POST["update_user"])) {
    ...
    header(
        "Location: index.php?page=user&msg=Akun & Data Terelasi Berhasil Diupdate",
    );
    exit();
}
...
if (isset($_POST["update_staff"])) {
    ...
    header(
        "Location: index.php?page=staff&msg=Data Staff & Akun SSO Berhasil Diupdate",
    );
    exit();
}
...
if (isset($_POST["update_pasien"])) {
    ...
    header(
        "Location: index.php?page=pasien&msg=Data Pasien & Akun SSO Berhasil Diupdate",
    );
    exit();
}
...
if (isset($_POST["add_supplier"])) {
    ...
    header(
        "Location: index.php?page=supplier&msg=Supplier Berhasil Ditambah",
    );
    exit();
}
...
if (isset($_POST["update_supplier"])) {
    ...
    header(
        "Location: index.php?page=supplier&msg=Data Supplier Berhasil Diupdate",
    );
    exit();
}
...
.chart-pie { position: relative; height: 260px; width: 100%; }
    ...
    <div class="sidebar">
        ...
        <nav class="nav flex-column gap-1">
            ...
            <a class="nav-link nav-link-logout js-swal-logout" href="../logout.php"><i class="bi bi-box-arrow-right"></i> Logout</a>
        </nav>
    </div>
