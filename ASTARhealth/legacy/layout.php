      ...
      <div class="d-flex align-items-center">
        ...
        <div class="dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-3">
            ...
            <li><a class="dropdown-item text-danger mt-2" href="../auth/logout.php"><i class="bi bi-box-arrow-right me-2"></i>Keluar</a></li>
          </ul>
        </div>
      </div>
    </div>
  ...
  <div class="master-nav">
    <div class="container text-center text-lg-start">
      <div class="d-flex flex-wrap justify-content-center justify-content-lg-start gap-1">
        <a href="../admin/index.php?page=user" class="nav-link-custom <?php echo ($active_page == 'user') ? 'active' : ''; ?>">
          <i class="bi bi-person-lock me-1"></i> User
        </a>
        <a href="../admin/index.php?page=staff" class="nav-link-custom <?php echo ($active_page == 'staff') ? 'active' : ''; ?>">
          <i class="bi bi-person-badge me-1"></i> Staff
        </a>
        <a href="../admin/index.php?page=pasien" class="nav-link-custom <?php echo ($active_page == 'pasien') ? 'active' : ''; ?>">
          <i class="bi bi-people me-1"></i> Pasien
        </a>
        <a href="../admin/index.php?page=obat" class="nav-link-custom <?php echo ($active_page == 'obat') ? 'active' : ''; ?>">
          <i class="bi bi-capsule me-1"></i> Obat
        </a>
        <a href="../admin/index.php?page=diagnosa" class="nav-link-custom <?php echo ($active_page == 'diagnosa') ? 'active' : ''; ?>">
          <i class="bi bi-clipboard2-pulse me-1"></i> Diagnosa
        </a>
        <a href="../admin/index.php?page=jadwal" class="nav-link-custom <?php echo ($active_page == 'jadwal') ? 'active' : ''; ?>">
          <i class="bi bi-calendar3 me-1"></i> Jadwal
        </a>
        <a href="../admin/index.php?page=supplier" class="nav-link-custom <?php echo ($active_page == 'supplier') ? 'active' : ''; ?>">
